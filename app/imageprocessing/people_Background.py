...
path_log_DT3 = "C:/Users/Nuntuch  Thongyoo/Desktop/Github_Projects/INT353_Senior-Project/NUM-SHOW_BANDIT/people_counter/graduation_ceremony/output/log_program.txt"
path_log_DTDew = "F:/log_program.txt"
...
path_purelog_DTDew = "F:/purelog_program.txt"
...
fp = open(path_purelog_DTDew, "a")
f = open(path_log_DTDew, "a")
f.write("\n")
f.write("\n")
f.write("\n")
...
f.write("\n")
f.write("[INFO] elapsed time Ofcutwhite: {:.2f}".format(
    fpsOfcutwhite.elapsed()))
f.write("\n")
...
fp.write("\n")
fp.write("[INFO] elapsed time Ofcutwhite: {:.2f}".format(
    fpsOfcutwhite.elapsed()))
fp.write("\n")
