...
class MFrameSetManagement:
  ...
  def _check_status_up_down_slope(self):
    status_up_down_slope_current = 0
    if MFrameSetManagement.m_frame_crop_mean_lpft_set[0] < MFrameSetManagement.m_frame_crop_mean_lpft_set[1] and MFrameSetManagement.m_frame_crop_mean_lpft_set[1] < MFrameSetManagement.m_frame_crop_mean_lpft_set[2] :
