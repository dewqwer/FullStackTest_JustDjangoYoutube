...
path_log_DT3 = "D:/log_program.txt"
path_log_NB5 = "D:/log_program.txt"

path_purelog_DT3 = "D:/purelog_program.txt"
path_purelog_NB5 = "D:/purelog_program.txt"

ap = argparse.ArgumentParser()
ap.add_argument("-i", "--input", type=str, default=path_vdo_input_DT3_0,
                help="path to optional input video file")
ap.add_argument("-fp", "--purelog", type=str, default=path_purelog_DT3,
                help="path_purelog")
ap.add_argument("-f", "--log", type=str, default=path_log_DT3,
                help="path_log")
...
fgMaskCutMean_befor_minus10 = 0
fgMaskCutMean_befor_minus11 = 0
fgMaskCutMean_befor_minus12 = 0
fgMaskCutMean_befor_minus13 = 0
fgMaskCutMean_befor_minus14 = 0
fgMaskCutMean_befor_minus15 = 0
fgMaskCutMean_befor_minus16 = 0
fgMaskCutMean_befor_minus17 = 0
fgMaskCutMean_befor_minus18 = 0
fgMaskCutMean_befor_minus19 = 0
# fgMaskCutMean_befor_minus20 = 0
fgMaskCutMeanAvg = 0
fgMaskCutMeanAvgMax = 0
fgMaskCutMeanAvgMin = 0
...
while True:
    ...
    # print(fgMask.shape)
    mc_sum_frame = imutils.resize(frame.copy(), width=1500)
    rgb_sum = cv2.cvtColor(frame.copy(), cv2.COLOR_BGR2RGB)
    ...
    if totalFrames % args["skip_frames"] == 0:
        ...
        # 120:150 170:190 , 450:420  X(232 60) _30_
        fgMaskCutCheckPeoplePass3 = fgMask[170:190, 420:450]
...
# _____________________________________Start CutCheckPeoplePass/Long Flash_____________________________________________
        ...
        # 120:150 170:190 , 450:420 ,240:270
        fgMaskCutCheckPeoplePass4 = fgMask[50:80, 200:230]
        ...
        # 120:150 170:190 , 450:420
        fgMaskCutCheckPeoplePass5 = fgMask[120:150, 200:230]

        fgMaskCutCheckPeoplePass5Mean = fgMaskCutCheckPeoplePass5.flatten().mean()

        # 120:150 170:190 , 450:420  X(232 60) _30_
        fgMaskCutCheckPeoplePass6 = fgMask[170:190, 200:230]
...
# ------------------------------------------------------------------------------------------------------------------
        ...
        # 120:150 170:190 , 450:420 ,240:270
        fgMaskCutCheckPeoplePass7 = fgMask[50:80, 60:90]
        ...
        # 120:150 170:190 , 450:420
        fgMaskCutCheckPeoplePass8 = fgMask[120:150, 60:90]

        fgMaskCutCheckPeoplePass8Mean = fgMaskCutCheckPeoplePass8.flatten().mean()

        # 120:150 170:190 , 450:420  X(232 60) _30_
        fgMaskCutCheckPeoplePass9 = fgMask[170:190, 60:90]
...
# 171 122
        ...
        if(fgMaskCutMean > 80  # 70 #80
           ...
           and detect_status == 0):
            ...
            print(fgMaskCutMean, fgMaskCutMean_befor_minus1,
                  fgMaskCutMean_befor_minus2, fgMaskCutMean_befor_minus3)
            print("_________________________________Count!!! ",
                  PeopleCount, "_________________________________")
        ...
        if(fgMaskCutMean - fgMaskCutMean_befor_minus1 >= 100
           ...
           and detect_status == 1):
            ...
            print("_________________________________Detect Noise (Short Flash) !!! ",
                  PeopleCount, "______________________________")
            f.write(
                "_________________________________Detect Noise (Short Flash) !!! ")
            f.write(PeopleCount)
        ...
        if((fgMaskCutMean+fgMaskCutMean_befor_minus1+fgMaskCutMean_befor_minus2)/3 >= 253
           and detect_status == 1):
            ...
            print("_________________________________Detect Noise (Other People Pass) !!! ",
                  PeopleCount, "______________________________")
            f.write(
                "_________________________________Detect Noise (Other People Pass) !!! ")
            f.write(str(PeopleCount))
            f.write("______________________________")
            f.write("\n")
        ...
        if((fgMaskCutCheckErrMean
           ...
           (fgMaskCutCheckErrMean
            ...
            print("_________________________________Detect Noise (Long Flash) !!! ",
                  PeopleCount, "______________________________")
        ...
        if(fgMaskCutMean < 80  # 80
           ...
           and SetFrameCount >= 15
            ...
            f.write(
                "_________________________________clear!!!_______________________________________________________")
            f.write("\n")
        ...
        if(fgMaskCutMean < 80  # 80
           ...
           and SetFrameCount <= 7  # 9 #12
            ...
            f.write(
                "________________________detect error frame set___clear!!!_______________________________________________________")
            f.write("\n")
    ...
    mc_sum_frame[0:281,0:500] = frame.copy() #11
    mc_sum_frame[281:281+281,0:500] = cv2.cvtColor(fgMask.copy(),cv2.COLOR_BGR2RGB) #12
    mc_sum_frame[0:281,500:500+500] = 0 #21 
    mc_sum_frame[281:281+281,500:500+500] = 0 #22
    mc_sum_frame[281+281:281+281+281,500:500+500] = 0 #23
    mc_sum_frame[281+281:281+281+281,0:500] = 0 #13
    mc_sum_frame[281+281:281+281+281,500+500:500+500+500] = 0 #33
    mc_sum_frame[281:281+281,500+500:500+500+500] = 0 #32
    mc_sum_frame[0:281,500+500:500+500+500] = 0 #31
    ...
    for (i, (k, v)) in enumerate(info_cut_white):
        text = "{}: {}".format(k, v)
        cv2.putText(mc_sum_frame, text, ((500*2*0)+30, H - ((i * 40) +20 -280*2)),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
    ...
    cv2.imshow('mc_sum_frame', mc_sum_frame)
...
f.write("\n")
f.write("[INFO] Detect Error Counts (People Pass)" +
        str(PeopleErrorCount_PeoplePass))
f.write("\n")
f.write("[INFO] Detect Error Counts (Short Flash)" +
        str(PeopleErrorCount_ShortFlash))
f.write("\n")
f.write("[INFO] Detect Error Counts (Long Flash)" +
        str(PeopleErrorCount_LongFlash))
f.write("\n")
f.write("[INFO] Detect Error Counts (ErrorFrameSetCount)" +
        str(ErrorFrameSetCount))
f.write("\n")
...
fp.write("\n")
fp.write("[INFO] Detect Error Counts (People Pass)" +
         str(PeopleErrorCount_PeoplePass))
fp.write("\n")
fp.write("[INFO] Detect Error Counts (Short Flash)" +
         str(PeopleErrorCount_ShortFlash))
fp.write("\n")
fp.write("[INFO] Detect Error Counts (Long Flash)" +
         str(PeopleErrorCount_LongFlash))
fp.write("\n")
fp.write("[INFO] Detect Error Counts (ErrorFrameSetCount)" +
         str(ErrorFrameSetCount))
fp.write("\n")
