...
# Create frame to shown on moniter 9*9_________Start____________________________________________________________________
    ...
    mc_frame = cm_arm._create_m_frame_line(mc_frame, cm_arm.x1_crop_arm_frame, cm_arm.y1_crop_arm_frame,
                                           cm_arm.x2_crop_arm_frame, cm_arm.y2_crop_arm_frame, "MFrameCropArm")
