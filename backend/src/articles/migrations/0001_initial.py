# Generated by Django 2.2.12 on 2020-09-19 15:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('facultyID', models.ForeignKey(db_column='faculty_facultyID', null=True, on_delete=django.db.models.deletion.CASCADE, to='articles.Faculty')),
            ],
            options={
                'db_table': 'major',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('majorID', models.ForeignKey(db_column='major_majorID', null=True, on_delete=django.db.models.deletion.CASCADE, to='articles.Major')),
            ],
            options={
                'db_table': 'time_major',
            },
